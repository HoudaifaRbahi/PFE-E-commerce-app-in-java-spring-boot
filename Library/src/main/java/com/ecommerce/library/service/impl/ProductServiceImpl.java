...
public class ProductServiceImpl implements ProductService {
    ...
    public Product update(MultipartFile imageProduct, ProductDto productDto) {
        try {
            Product productUpdate = productRepository.findById(productDto.getId()).get();
            if (imageProduct == null) {
    ...
    public Page<ProductDto> getAllProducts(int pageNo) {
        ...
        List<ProductDto> productDtoLists = transferData(productRepository.findAll());
    ...
    @Override
    public void updateQuantity(Long id, int currentQuantity) {
        Product product=productRepository.findById(id).get();
        int quantity=product.getCurrentQuantity();
        product.setCurrentQuantity(quantity-currentQuantity);
        productRepository.save(product);
    }
    ...
    @Override
    public List<Product> nearingCompletion() {
        return productRepository.nearingCompletion();
    }
    ...
    @Override
    public List<Product> LeastSeller() {
        return productRepository.LeastSeller();
    }
